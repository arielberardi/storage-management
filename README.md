...
| Dashboard                     | File Management                  | Sign Up                   |
| ----------------------------- | -------------------------------- | ------------------------- |
| ![Dashboard](./dashboard.png) | ![File Management](./images.png) | ![Sign Up](./sign-up.png) |
...
Thanks to JavaScript Mastery for such an amazing tutorial.
